...
var postgresList_1 = require("./postgresList");
function postgres(program, glueStackPlugin) {
    var _this = this;
    var command = program
        .command("postgres")
    ...
    command
        ...
        return [2, (0, postgresConfig_1.postgresConfig)(glueStackPlugin)];
    }); }); });
    command
        .command("list")
        .description("List installed postgres instances")
        .action(function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2, (0, postgresList_1.postgresList)(glueStackPlugin)];
    }); }); });
}
