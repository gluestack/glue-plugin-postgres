...
function postgresList(glueStackPlugin) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            arr = glueStackPlugin.getInstances().map(function (instance) {
                var db = instance.gluePluginStore.get("db_config") || {};
                return __assign({ instance: instance.getName() }, db);
            });
            console.table(arr);
            return [2];
        });
...
exports.postgresList = postgresList;
//# sourceMappingURL=postgresList.js.map